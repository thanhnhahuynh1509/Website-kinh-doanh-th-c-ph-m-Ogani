            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="${pageContext.request.contextPath}/admin/account"> Danh sách tài khoản</a>
                        </li>
                        <li class="breadcrumb-item">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <button onclick="window.location.href = '/admin/account'"
                                        class="btn btn-warning waves-effect waves-light"><i class="fa-solid fa-rotate-left"></i>
                                    Trở về
                                </button>
                            </div>
                        </div>
                                            ...
                                            <c:forEach items="${requestScope.admins}" var="item">
                                                <c:if test="${item.id != sessionScope.admin.id}">
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="align-middle">
                                                            <button class="btn btn-sm btn-round btn-secondary waves-effect waves-light js-restore"
                                                                    data-id="${item.id}">
                                                                <i class="fa-solid fa-trash-arrow-up"></i>
                                                            </button>
                                                            <button class="btn btn-sm btn-round btn-danger waves-effect waves-light" onclick="window.location.href='/admin/account/confirm-delete?id=${item.id}'">
...
<script>
    $(document).ready(function () {
        ...
        $(".js-restore").on('click', function (e) {
            ...
            if (confirm("Bạn có chắc chắn khôi phục dữ liệu?")) {
                $.ajax({
                    url: '/admin/account/active?id=' + btn.attr("data-id"),
                    type: 'POST'
                }).done(function (data) {
