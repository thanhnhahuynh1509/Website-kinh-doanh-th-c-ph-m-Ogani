                                            ...
                                            <c:forEach items="${requestScope.orders}" var="item">
                                                <tr class="text-center" >
                                                    ...
                                                    <td>
                                                        ...
                                                        <button class="btn btn-sm btn-round btn-danger waves-effect waves-light btn-delete" data-id="${item.id}">
...
<script>
    $(document).ready(function() {
        $(".btn-delete").on("click", function() {
            ...
            if(confirm("Bạn có chắc chắn muốn xóa dữ liệu với mã số #" + id + " ?" )) {
                window.location.href = '/admin/order/delete?id=' + id;
            }
        })
    });
</script>
