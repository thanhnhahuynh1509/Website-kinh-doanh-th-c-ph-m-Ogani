                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <button onclick="window.location.href = '/admin/product/not-active'" class="btn btn-warning waves-effect waves-light"><i class="fa-solid fa-ban"></i> Không hoạt động</button>
                                <button onclick="window.location.href = '/admin/product/trash'" class="btn btn-danger waves-effect waves-light"><i class="fa-solid fa-trash"></i> Thùng rác</button>
                                <button onclick="window.location.href = '/admin/product/create'" class="btn btn-success waves-effect waves-light"><i class="fa-solid fa-plus"></i> Thêm</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        $(".js-not-active").on('click', function(e) {
            ...
            if(confirm("Bạn có chắc chắn muốn chuyển trạng thái của dữ liệu sang không hoạt động?")) {
                $.ajax({
                    url: '/admin/product/not-active?id=' + btn.attr("data-id"),
                    type: 'POST'
                }).done(function (data) {
