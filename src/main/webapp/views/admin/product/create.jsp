...
<div class="pcoded-content">
    ...
    <form id="formInput" method="post" action="${pageContext.request.contextPath}/admin/product/create" enctype="multipart/form-data">
        <!-- Page-feature -->
                            ...
                            <div class="card" style="flex: 1">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="prices" value="1000" class="form-control" min="0" id="prices">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-static-label" for="sale">Giảm giá (%) <span style="color:red">(*)</span></label>
                                        <input type="number" name="sale" value="0" class="form-control" min="0" id="sale">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="weight" value="0" class="form-control" min="0" id="weight">
                                    </div>
                                    <div class="form-group">
