                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <button onclick="javascript:history.go(-1)" class="btn btn-primary waves-effect waves-light"><i class="fa-solid fa-arrow-rotate-left"></i> Trở lại</button>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <c:forEach items="${requestScope.orders}" var="item">
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <button class="btn btn-sm btn-round btn-primary waves-effect waves-light" onclick="window.location.href = '/admin/order/detail?id=${item.id}'">
                                                            <i class="fa-solid fa-eye"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-round btn-success waves-effect waves-light btn-change-status" data-id="${item.id}" data-status="Giao hàng thành công">
...
<script>
    $(document).ready(function() {
        $(".btn-change-status").on("click", function() {
            ...
            if(confirm("Chuyển trạng thái của mật hàng có mã số là " + id + " sang trạng thái Giao hàng thành công ?")) {
